...
-(NSNumber*) snipPostWithCodeSnippetBody: (SWGCodeSnippet*) codeSnippetBody
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/snip"];
...
-(NSNumber*) snipCodeSnippetUuidGetWithCodeSnippetUuid: (NSString*) codeSnippetUuid
    ...
    if (codeSnippetUuid == nil) {
        [NSException raise:@"Invalid parameter" format:@"Missing the required parameter `codeSnippetUuid` when calling `snipCodeSnippetUuidGet`"];
    }
    

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/snip/{code_snippet_uuid}"];
    ...
    NSMutableDictionary *pathParams = [[NSMutableDictionary alloc] init];
    if (codeSnippetUuid != nil) {
        pathParams[@"code_snippet_uuid"] = codeSnippetUuid;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGCodeSnippet*"
                           completionBlock: ^(id data, NSError *error) {
                               handler((SWGCodeSnippet*)data, error);
                           }
          ];
}
...
-(NSNumber*) snipCodeSnippetUuidPutWithCodeSnippetUuid: (NSString*) codeSnippetUuid
    ...
    // verify the required parameter 'codeSnippetUuid' is set
    if (codeSnippetUuid == nil) {
        [NSException raise:@"Invalid parameter" format:@"Missing the required parameter `codeSnippetUuid` when calling `snipCodeSnippetUuidPut`"];
    }
...
-(NSNumber*) snipCodeSnippetUuidDeleteWithCodeSnippetUuid: (NSString*) codeSnippetUuid
    ...
    // verify the required parameter 'codeSnippetUuid' is set
    if (codeSnippetUuid == nil) {
        [NSException raise:@"Invalid parameter" format:@"Missing the required parameter `codeSnippetUuid` when calling `snipCodeSnippetUuidDelete`"];
    }
...
-(NSNumber*) snipsGetWithCompletionHandler: 
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/snips"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGCodeSnippetList*"
                           completionBlock: ^(id data, NSError *error) {
                               handler((SWGCodeSnippetList*)data, error);
                           }
          ];
}
